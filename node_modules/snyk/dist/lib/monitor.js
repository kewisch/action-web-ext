...
function filterOutMissingDeps(depTree) {
    ...
    for (const depKey of Object.keys(depTree.dependencies)) {
        ...
        if (dep.missingLockFileEntry) { // TODO(kyegupov): add field to the type
...
function monitor(root, meta, info, targetFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (meta['experimental-dep-graph'] && package_managers_1.GRAPH_SUPPORTED_PACKAGE_MANAGERS.includes(packageManager)) {
