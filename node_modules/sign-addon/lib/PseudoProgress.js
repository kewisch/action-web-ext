...
class PseudoProgress {
  ...
  finish() {
    ...
    this.fillBucket(); // The bucket has already filled to the terminal width at this point
  ...
  randomlyFillBucket() {
    ...
    const randomIndex = Math.floor(Math.random() * this.emptyBucketPointers.length);
...
//# sourceMappingURL=PseudoProgress.js.map