let path,fs,webExt,signAddon,yauzl,getStream,github,core,CheckRun;_276‍.x([["default",()=>WebExtAction]]);_276‍.w("path",[["default",["path"],function(v){path=v}]]);_276‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_276‍.w("web-ext",[["default",["webExt"],function(v){webExt=v}]]);_276‍.w("sign-addon",[["default",["signAddon"],function(v){signAddon=v}]]);_276‍.w("yauzl-promise",[["default",["yauzl"],function(v){yauzl=v}]]);_276‍.w("get-stream",[["default",["getStream"],function(v){getStream=v}]]);_276‍.w("@actions/github",[["*",null,function(v){github=v}]]);_276‍.w("@actions/core",[["*",null,function(v){core=v}]]);_276‍.w("./checkrun",[["default",["CheckRun"],function(v){CheckRun=v}]]);/* This Source Code Form is subject to the terms of the Mozilla Public
...
async function getManifest(xpi) {
  ...
  async cmd_lint() {
    ...
    if (!this.options.token) {
      _276‍.g.console.log(results.notices.concat(results.warnings).concat(results.errors).map(linterToString).join("\n") + "\n");
    }
    _276‍.g.console.log(summaryLine);
  ...
  async cmd_sign() {
    ...
    if (this.options.channel == "listed") {
      ...
      _276‍.g.console.log("Downloaded these files: " + result.downloadedFiles);
      return {
        addon_id: result.id,
