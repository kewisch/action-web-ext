...
exports["default"] = exports.create = exports.DEPRECATED_ENTITIES = void 0;
...
const rule = {
  create(context) {
    return {
      ...
      CallExpression(node) {
        const referenceNode = (0, _utils.getNodeReference)(context, node.callee); // We're only looking for calls that look like `foo.bar()`.

        if (typeof referenceNode.object !== 'undefined' && referenceNode.property.type === 'Identifier' && referenceNode.object.type === 'Identifier') {
          const referenceObject = (0, _utils.getNodeReference)(context, referenceNode.object);

          for (let i = 0; i < DEPRECATED_ENTITIES.length; i++) {
            const entity = DEPRECATED_ENTITIES[i]; // Check to see if the node matches a deprecated entity.
