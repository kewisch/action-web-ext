...
function _templateObject4() {
  var data = (0, _taggedTemplateLiteral2["default"])(["\n      ", " allows 'eval', which has strong security and performance implications."]);
...
function _templateObject3() {
  var data = (0, _taggedTemplateLiteral2["default"])(["\n      \"", "\" allows remote code execution in manifest.json"]);
...
function _templateObject2() {
  var data = (0, _taggedTemplateLiteral2["default"])(["See https://mzl.la/2Qn0fWC\n    (MDN Docs) for more information."]);
...
var MANIFEST_FIELD_UNSUPPORTED = 'MANIFEST_FIELD_UNSUPPORTED';
exports.MANIFEST_FIELD_UNSUPPORTED = MANIFEST_FIELD_UNSUPPORTED;

function manifestFieldUnsupported(fieldName) {
  return {
    code: 'MANIFEST_FIELD_UNSUPPORTED',
    message: _utils.i18n._('Manifest field not supported.'),
    description: _utils.i18n.sprintf(_utils.i18n._('"%(fieldName)s" is not supported.'), {
      fieldName: fieldName
    }),
    file: _const.MANIFEST_JSON
  };
...
var MANIFEST_BAD_OPTIONAL_PERMISSION = {
...
var MANIFEST_OPTIONAL_PERMISSIONS = {
...
function manifestCsp(property) {
  return {
    ...
    code: MANIFEST_CSP,
    message: _utils.i18n._((0, _commonTags.oneLine)(_templateObject3(), property)),
    description: _utils.i18n._("A custom ".concat(property, " needs additional review.")),
    file: _const.MANIFEST_JSON
  };
}

var MANIFEST_CSP_UNSAFE_EVAL = 'MANIFEST_CSP_UNSAFE_EVAL';
...
function manifestCspUnsafeEval(property) {
  return {
    ...
    message: _utils.i18n._((0, _commonTags.oneLine)(_templateObject4(), property)),
    description: _utils.i18n._((0, _commonTags.oneLine)(_templateObject5())),
    file: _const.MANIFEST_JSON
  };
}
...
function iconSizeInvalid(_ref) {
  ...
  return {
    ...
    description: _utils.i18n.sprintf(_utils.i18n._((0, _commonTags.oneLine)(_templateObject9())), {
      path: path,
      expected: expected,
      actual: actual
    }),
...
function permissionFirefoxAndroidUnsupportedByMinVersion(key, minVersion, versionAdded) {
  return {
    ...
    description: _utils.i18n.sprintf(_utils.i18n._((0, _commonTags.oneLine)(_templateObject15())), {
      key: key,
      minVersion: minVersion,
      versionAdded: versionAdded
    }),
...
var _imported = _interopRequireDefault(__webpack_require__(36));
...
var schemas = _imported["default"].reduce(function (all, current) {
  return _objectSpread(_objectSpread({}, all), {}, (0, _defineProperty2["default"])({}, current.id, current));
}, {});

function getObjectProperty(schema, property) {
  var _iterator = _createForOfIteratorHelper(schemaObjectNames),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var schemaProperty = _step.value;
...
function getArrayProperty(schema, property) {
  var _iterator2 = _createForOfIteratorHelper(schemaArrayNames),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var schemaProperty = _step2.value;

      if (schema && schemaProperty in schema) {
        var namespaceProperties = schema[schemaProperty];

        if (Array.isArray(namespaceProperties)) {
          var _iterator3 = _createForOfIteratorHelper(namespaceProperties),
              _step3;
...
function isDeprecatedApi(namespace, property) {
  ...
  var schemaItem = getObjectProperty(schema, property) || getArrayProperty(schema, property);
  return schemaItem !== null && schemaItem.deprecated !== undefined || Object.prototype.hasOwnProperty.call(_const.DEPRECATED_JAVASCRIPT_APIS, "".concat(namespace, ".").concat(property));
}

function hasBrowserApi(namespace, property) {
  var schema = schemas[namespace]; // We "have" the API if it's deprecated or temporary so we don't double warn.

  if (isTemporaryApi(namespace, property) || isDeprecatedApi(namespace, property)) {
    return true;
  }
...
var _activity_log = _interopRequireDefault(__webpack_require__(37));

var _alarms = _interopRequireDefault(__webpack_require__(38));

var _bookmarks = _interopRequireDefault(__webpack_require__(39));

var _browser_action = _interopRequireDefault(__webpack_require__(40));

var _browser_settings = _interopRequireDefault(__webpack_require__(41));

var _browsing_data = _interopRequireDefault(__webpack_require__(42));

var _captive_portal = _interopRequireDefault(__webpack_require__(43));

var _chrome_settings_overrides = _interopRequireDefault(__webpack_require__(44));

var _clipboard = _interopRequireDefault(__webpack_require__(45));

var _commands = _interopRequireDefault(__webpack_require__(46));

var _content_scripts = _interopRequireDefault(__webpack_require__(47));

var _contextual_identities = _interopRequireDefault(__webpack_require__(48));

var _cookies = _interopRequireDefault(__webpack_require__(49));

var _devtools = _interopRequireDefault(__webpack_require__(50));

var _dns = _interopRequireDefault(__webpack_require__(51));

var _downloads = _interopRequireDefault(__webpack_require__(52));

var _events = _interopRequireDefault(__webpack_require__(53));

var _experiments = _interopRequireDefault(__webpack_require__(54));

var _extension = _interopRequireDefault(__webpack_require__(55));

var _extension_protocol_handlers = _interopRequireDefault(__webpack_require__(56));

var _extension_types = _interopRequireDefault(__webpack_require__(57));

var _find = _interopRequireDefault(__webpack_require__(58));

var _geckoProfiler = _interopRequireDefault(__webpack_require__(59));

var _history = _interopRequireDefault(__webpack_require__(60));

var _i18n = _interopRequireDefault(__webpack_require__(61));

var _identity = _interopRequireDefault(__webpack_require__(62));

var _idle = _interopRequireDefault(__webpack_require__(63));

var _management = _interopRequireDefault(__webpack_require__(64));

var _menus = _interopRequireDefault(__webpack_require__(65));

var _native_manifest = _interopRequireDefault(__webpack_require__(66));

var _network_status = _interopRequireDefault(__webpack_require__(67));

var _normandyAddonStudy = _interopRequireDefault(__webpack_require__(68));

var _notifications = _interopRequireDefault(__webpack_require__(69));

var _omnibox = _interopRequireDefault(__webpack_require__(70));

var _page_action = _interopRequireDefault(__webpack_require__(71));

var _permissions = _interopRequireDefault(__webpack_require__(72));

var _pkcs = _interopRequireDefault(__webpack_require__(73));

var _privacy = _interopRequireDefault(__webpack_require__(74));

var _proxy = _interopRequireDefault(__webpack_require__(75));

var _runtime = _interopRequireDefault(__webpack_require__(76));

var _search = _interopRequireDefault(__webpack_require__(77));

var _sessions = _interopRequireDefault(__webpack_require__(78));

var _sidebar_action = _interopRequireDefault(__webpack_require__(79));

var _storage = _interopRequireDefault(__webpack_require__(80));

var _tabs = _interopRequireDefault(__webpack_require__(81));

var _telemetry = _interopRequireDefault(__webpack_require__(82));

var _test = _interopRequireDefault(__webpack_require__(83));

var _theme = _interopRequireDefault(__webpack_require__(84));

var _top_sites = _interopRequireDefault(__webpack_require__(85));

var _types = _interopRequireDefault(__webpack_require__(86));

var _url_overrides = _interopRequireDefault(__webpack_require__(87));

var _urlbar = _interopRequireDefault(__webpack_require__(88));

var _userScripts = _interopRequireDefault(__webpack_require__(89));

var _web_navigation = _interopRequireDefault(__webpack_require__(90));

var _web_request = _interopRequireDefault(__webpack_require__(91));

var _windows = _interopRequireDefault(__webpack_require__(92));

var _context_menus = _interopRequireDefault(__webpack_require__(93));

// This file is generated by the schema import script.
var _default = [_activity_log["default"], _alarms["default"], _bookmarks["default"], _browser_action["default"], _browser_settings["default"], _browsing_data["default"], _captive_portal["default"], _chrome_settings_overrides["default"], _clipboard["default"], _commands["default"], _content_scripts["default"], _contextual_identities["default"], _cookies["default"], _devtools["default"], _dns["default"], _downloads["default"], _events["default"], _experiments["default"], _extension["default"], _extension_protocol_handlers["default"], _extension_types["default"], _find["default"], _geckoProfiler["default"], _history["default"], _i18n["default"], _identity["default"], _idle["default"], _management["default"], _menus["default"], _native_manifest["default"], _network_status["default"], _normandyAddonStudy["default"], _notifications["default"], _omnibox["default"], _page_action["default"], _permissions["default"], _pkcs["default"], _privacy["default"], _proxy["default"], _runtime["default"], _search["default"], _sessions["default"], _sidebar_action["default"], _storage["default"], _tabs["default"], _telemetry["default"], _test["default"], _theme["default"], _top_sites["default"], _types["default"], _url_overrides["default"], _urlbar["default"], _userScripts["default"], _web_navigation["default"], _web_request["default"], _windows["default"], _context_menus["default"]];
exports["default"] = _default;
...
module.exports = JSON.parse("{\"id\":\"networkStatus\",\"description\":\"This API provides the ability to determine the status of and detect changes in the network connection. This API can only be used in privileged extensions.\",\"permissions\":[\"networkStatus\"],\"functions\":[{\"name\":\"getLinkInfo\",\"type\":\"function\",\"description\":\"Returns the $(ref:NetworkLinkInfo} of the current network connection.\",\"async\":true,\"parameters\":[]}],\"events\":[{\"name\":\"onConnectionChanged\",\"type\":\"function\",\"description\":\"Fired when the network connection state changes.\",\"parameters\":[{\"allOf\":[{\"$ref\":\"#/types/NetworkLinkInfo\"},{\"name\":\"details\"}]}]}],\"definitions\":{\"PermissionNoPrompt\":{\"anyOf\":[{\"type\":\"string\",\"enum\":[\"networkStatus\"]}]}},\"refs\":{\"networkStatus#/definitions/PermissionNoPrompt\":{\"namespace\":\"manifest\",\"type\":\"PermissionNoPrompt\"}},\"types\":{\"NetworkLinkInfo\":{\"type\":\"object\",\"properties\":{\"status\":{\"type\":\"string\",\"enum\":[\"unknown\",\"up\",\"down\"],\"description\":\"Status of the network link, if \\\"unknown\\\" then link is usually assumed to be \\\"up\\\"\"},\"type\":{\"type\":\"string\",\"enum\":[\"unknown\",\"ethernet\",\"usb\",\"wifi\",\"wimax\",\"2g\",\"3g\",\"4g\"],\"description\":\"If known, the type of network connection that is avialable.\"},\"id\":{\"type\":\"string\",\"description\":\"If known, the network id or name.\"}},\"required\":[\"status\",\"type\"]}}}");
...
var messages = _interopRequireWildcard(__webpack_require__(21));

var _const = __webpack_require__(17);

var _browserApis = __webpack_require__(35);
    ...
    return {
      MemberExpression: function MemberExpression(node) {
        if (!node.computed && node.object.object && (0, _utils.isBrowserNamespace)(node.object.object.name)) {
          ...
          if ((0, _browserApis.hasBrowserApi)(namespace, property) && (0, _browserApis.isDeprecatedApi)(namespace, property)) {
            var msgId = _const.DEPRECATED_JAVASCRIPT_APIS[api];
            var messageObject = // eslint-disable-next-line import/namespace
