module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "inkognito „split“ wird nicht unterstützt." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Der inkognito-Wert „split“ wird nicht unterstützt und wird in Firefox als „not_allowed“ behandelt. Entfernen Sie den Schlüssel aus der Manifest-Datei, wenn Ihre Erweiterung mit dem privaten Modus von Firefox kompatibel ist." ],
      "The \"admin_install_only\" property is reserved.":[ "Die Eigenschaft „admin_install_only“ ist reserviert." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Die Eigenschaft „admin_install_only“ ist reserviert und kann nur in Add-ons für Unternehmen verwendet werden." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "Die Eigenschaft „/browser_specific_settings/gecko/admin_install_only“ muss auf „true“ gesetzt werden." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "Die Eigenschaft „admin_install_only“ muss in einem Add-on für Unternehmen auf „true“ gesetzt werden." ],
