module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Remote scripts are not allowed as per the Add-on Policies.":[ "کدنوشته‌های دوردست طبق سیاست‌های افزونه مجاز نیستند." ],
      "Please include all scripts in the add-on. For more information, refer to https://mzl.la/2uEOkYp.":[ "" ],
      "Inline scripts blocked by default":[ "کدنوشته‌های درون‌خطی به طور پیش‌فرض مسدود شده‌اند" ],
      "Default CSP rules prevent inline JavaScript from running (https://mzl.la/2pn32nd).":[ "" ],
      "Unadvised 3rd-party JS library":[ "کتابخانهٔ JS سوم‌شخص توصیه نشده" ],
      ...
      "{{api}} is not supported":[ "‏{{api}} پشتیبانی نمی‌شود" ],
      "This API has not been implemented by Firefox.":[ "این API توسط Firefox پیاده‌سازی نشده است." ],
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "" ],
      "{{api}} is deprecated":[ "‏{{api}} منسوخ شده است" ],
