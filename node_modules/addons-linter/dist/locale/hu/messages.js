module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Invalid install origin.":[ null,
        "Érvénytelen telepítési eredet." ],
      "Invalid install origin. A valid origin has - only - a scheme, hostname and optional port.":[ null,
        "Érvénytelen telepítési eredet. Egy érvényes eredet csak sémát, gépnevet és portot (nem kötelező) tartalmaz." ],
      ...
      "The extension ID is required in Manifest Version 3 and above.":[ null,
        "A bővítményazonosító kötelező a Manifest 3-as és újabb verzióiban." ],
      "See https://mzl.la/3PLZYdo for more information.":[ null,
        "További információkért lásd: https://mzl.la/3PLZYdo." ] } } }