module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "incognito ‘split’ wordt niet ondersteund." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "De incognito ‘split’-waarde wordt niet ondersteund en wordt in Firefox behandeld als ‘not_allowed’. Verwijder de sleutel uit het manifest-bestand, als uw extensie compatibel is met de privénavigatiemodus van Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "De eigenschap ‘admin_install_only’ is gereserveerd." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "De eigenschap ‘admin_install_only’ is gereserveerd en kan alleen in ondernemingsadd-ons worden gebruikt." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "De eigenschap ‘/browser_specific_settings/gecko/admin_install_only’ moet zijn ingesteld op ‘true’." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "De eigenschap ‘admin_install_only’ moet zijn ingesteld op ‘true’ in een ondernemingsadd-on." ],
