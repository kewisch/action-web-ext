module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Regel" ],
      Column:[ "Kolom" ],
      "Invalid nesting of selectors found":[ "Ongeldig nesten van selectors gevonden" ],
      "A CSS syntax error was encountered":[ "Er is een CSS-syntaxisfout aangetroffen" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` aangeroepen met ‘truthy’ vierde argument." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Een aangepast content_security_policy heeft aanvullende beoordeling nodig." ],
      "The \"name\" property must be a string.":[ "De eigenschap ‘name’ moet een tekenreeks zijn." ],
      ...
      "The \"version\" property must be a string.":[ "De eigenschap ‘version’ moet een tekenreeks zijn." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Zie http://mzl.la/1kXIADa (MDN Docs) voor meer informatie." ],
      "The \"version\" property uses a Firefox-specific format.":[ "De eigenschap ‘version’ gebruikt een Firefox-specifieke notatie." ] } } }