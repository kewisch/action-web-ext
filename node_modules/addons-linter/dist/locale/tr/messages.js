module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Satır" ],
      Column:[ "Sütun" ],
      "Invalid manifest version range requested: --min-manifest-version (currently set to %(minManifestVersion)s) should not be greater than --max-manifest-version (currently set to %(maxManifestVersion)s).":[ "Geçersiz manifest sürümü aralığı istendi: --min-manifest-version değeri (şu anda %(minManifestVersion)s olarak ayarlı) --max-manifest-version değerinden (şu anda %(maxManifestVersion)s olarak ayarlı) büyük olamaz." ],
      ...
      "Calling \"%(method)s\" with a non-local URI will result in the dialog being opened with chrome privileges.":[ "Yerel olmayan bir URI ile \"%(method)s\" çağrısı yapmak iletişim kutusunun chrome ayrıcalıklarıyla açılmasına neden olur." ],
      ...
      "The \"default_locale\" value is specified in the manifest, but no matching \"messages.json\" in the \"_locales\" directory exists. See: https://mzl.la/2hjcaEE":[ "Manifest dosyasında \"default_locale\" değeri belirtilmiş ancak \"_locales\" dizininde eşleşen bir \"messages.json\" dosyası yok. Daha fazla bilgi için https://mzl.la/2hjcaEE sayfasına bakın" ],
      "The \"default_locale\" is missing but \"_locales\" exist.":[ "\"default_locale\" eksik fakat \"_locales\" mevcut." ],
      "The \"default_locale\" value is not specifed in the manifest, but a \"_locales\" directory exists. See: https://mzl.la/2hjcaEE":[ "Manifest’te \"default_locale\" değeri belirtilmemiş ancak bir \"_locales\" dizini var. Daha fazla bilgi için https://mzl.la/2hjcaEE sayfasına bakın" ],
      ...
      "The \"%(permission)s\" permission requires \"strict_min_version\" to be set to \"%(minFirefoxVersion)s\" or above":[ "\"%(permission)s\" izni için \"strict_min_version\"un \"%(minFirefoxVersion)s\" veya daha yüksek bir değere ayarlanması gerekir" ],
      "The \"%(permission)s\" permission requires \"strict_min_version\" to be set to \"%(minFirefoxVersion)s\" or above. Please update your manifest.json version to specify a minimum Firefox version.":[ "\"%(permission)s\" izni için \"strict_min_version\"un \"%(minFirefoxVersion)s\" veya daha yüksek bir değere ayarlanması gerekir. Minimum Firefox sürümünü belirlemek için lütfen manifest.json sürümünüzü güncelleyin." ],
      ...
      "The \"admin_install_only\" property is reserved.":[ "\"admin_install_only\" özelliği rezervedir." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "\"admin_install_only\" özelliği rezervedir ve yalnızca kurumsal eklentilerde kullanılabilir." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "\"/browser_specific_settings/gecko/admin_install_only\" özelliği \"true\" olarak ayarlanmalıdır." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "\"admin_install_only\" özelliği kurumsal eklentilerde \"true\" olarak ayarlanmalıdır." ],
