module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "incognito \"split\" není podporováno." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Hodnota \"split\" pro inkognito není podporována a ve Firefoxu bude považována za \"not_allowed\". Pokud je vaše rozšíření kompatibilní s režimem anonymního prohlížení ve Firefoxu, odstraňte tento klíč ze souboru manifest." ],
