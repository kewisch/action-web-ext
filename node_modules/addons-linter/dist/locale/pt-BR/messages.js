module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "não há suporte para o valor \"split\" de \"incognito\"" ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Não há suporte para o valor \"split\" da chave \"incognito\", será tratado como \"not_allowed\" no Firefox. Remova a chave do arquivo de manifesto, se a extensão for compatível com o modo de navegação privativa do Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "A propriedade \"admin_install_only\" é reservada." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "A propriedade \"admin_install_only\" é reservada e só pode ser usada em extensões corporativas." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "A propriedade \"/browser_specific_settings/gecko/admin_install_only\" deve ser definida como \"true\"." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "A propriedade \"admin_install_only\" deve ser definida como \"true\" em uma extensão corporativa." ],
