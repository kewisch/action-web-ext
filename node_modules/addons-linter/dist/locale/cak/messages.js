module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "B'ey" ],
      Column:[ "Tem" ],
      "Invalid nesting of selectors found":[ "Ye'ilitäj itzel kisok cha'onela'" ],
      "A CSS syntax error was encountered":[ "Xilitäj jun rusachj CSS cholb'ab'" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` oyon rik'in jun okel rukaj na'oj." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Richin nichinäx ri content_security_policy nrajo' chi ninik'öx chik." ],
      "The \"name\" property must be a string.":[ "Ri \"name\" ichinil k'o chi jun string." ],
      ...
      "The \"version\" property must be a string.":[ "Ri richinil \"version\" k'o chi jun string." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Titz'et http://mzl.la/1kXIADa (MDN Wujil) richin ch'aqa' chik etamab'äl." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Ri \"version\" ichinil nrokisaj jun jikil rub'anikil Firefox." ] } } }