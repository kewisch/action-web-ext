module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "Inkognitovärdet \"split\" stöds inte." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Inkognitovärdet \"split\" stöds inte och kommer att behandlas som \"not_allowed\" i Firefox. Ta bort nyckeln från manifestfilen, om ditt tillägg är kompatibelt med Firefox privata surfläge." ],
      "The \"admin_install_only\" property is reserved.":[ "Egenskapen \"admin_install_only\" är reserverad." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Egenskapen \"admin_install_only\" är reserverad och kan endast användas i företagstillägg." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "Egenskapen \"/browser_specific_settings/gecko/admin_install_only\" måste vara inställd på \"true\"." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "Egenskapen \"admin_install_only\" måste vara inställd på \"true\" i ett företagstillägg." ],
