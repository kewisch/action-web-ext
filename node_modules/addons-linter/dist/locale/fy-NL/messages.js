module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "ynkognito ‘split’ wurdt net stipe." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "De ynkognito ‘split’-wearde wurdt net stipe en wurdt yn Firefox behannele as ‘not_allowed’. Smyt de kaai út it manifest-bestân fuort, as jo útwreiding kompatibel is mei de priveenavigaasjemodus fan Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "De eigenskip ‘admin_install_only’ is reservearre." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "De eigenskip ‘admin_install_only’ is reservearre en kin allinnich brûkt wurde yn ûndernimmings-add-ons." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "De eigenskip ‘/browser_specific_settings/gecko/admin_install_only’ moat ynsteld wêze op ‘true’." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "De eigenskip ‘admin_install_only’ moat ynsteld wêze op ‘true’ yn in ûndernimmings-add-on." ],
