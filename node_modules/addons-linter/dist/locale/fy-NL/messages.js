module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Rige" ],
      Column:[ "Kolom" ],
      "Invalid nesting of selectors found":[ "Unjildich nesten fan selectors fûn" ],
      "A CSS syntax error was encountered":[ "Der is in CSS-syntaksisflater oantroffen" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` oanroppen mei ‘truthy’ fjirde argumint." ],
      ...
      "A custom content_security_policy needs additional review.":[ "In oanpast content_security_policy hat oanfoljende beoardieling nedich." ],
      ...
      "The \"version\" property must be a string.":[ "De eigenskip ‘version’ moat in tekenreeks wêze." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Sjoch http://mzl.la/1kXIADa (MDN Docs) foar mear ynformaasje." ],
      "The \"version\" property uses a Firefox-specific format.":[ "De eigenskip ‘version’ brûkt in Firefox-spesifike notaasje." ] } } }