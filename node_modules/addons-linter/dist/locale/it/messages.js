module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "La modalità di navigazione anonima “split” non è supportata." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Il valore “split” per la chiave “incognito” non è supportato e verrà valutato come “not_allowed” in Firefox. Rimuovi la chiave dal file manifesto se l’estensione è compatibile con la modalità di navigazione anonima di Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "La proprietà “admin_install_only” è riservata." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "La proprietà “admin_install_only” è riservata e può essere utilizzata solo in componenti aggiuntivi aziendali." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "La proprietà “/browser_specific_settings/gecko/admin_install_only” deve avere il valore “true”." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "La proprietà “admin_install_only” deve avere il valore “true” in un componente aggiuntivo aziendale." ],
