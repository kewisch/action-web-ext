module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "JavaScript libraries are discouraged for simple add-ons, but are generally accepted.":[ "Za jadnore dodanki wót bibliotekow JavaScript wótraźuju, ale zwětšego je akceptěruju." ],
      ...
      "Content script file name should not be empty":[ "Mě wopśimjeśoweje skriptoweje dataje njeměło prozne byś" ],
      "\"%(method)s\" called with a non-literal uri":[ "„%(method)s“ jo se wuwołała z njeliteralnym uri" ],
      ...
      "\"%(method)s\" called with non-local URI":[ "„%(method)s“ jo se wuwołała z njelokalnym uri" ],
      ...
      "\"%(property)s\" allows 'eval', which has strong security and performance implications.":[ "„%(property)s“ ‚eval‘ dowólujo, což ma mócne wustatkowanja na wěstotu a wugbaśe." ],
      ...
      "\"%(fieldName)s\" manifest field is only used for privileged and temporarily installed extensions.":[ "Manifestowe pólo „%(fieldName)s“ se jano za priwilegěrowane a nachylu instalěrowane rozšyrjenja wužywa." ],
      ...
      "Please refer to https://github.com/mozilla-extensions/xpi-manifest to learn more about privileged extensions and signing.":[ "Cytajśo pšosym https://github.com/mozilla-extensions/xpi-manifest, aby wěcej wó priwilegěrowanych rozšyrjenjach a signěrowanju zgónił." ],
      ...
      "The \"default_locale\" value is specified in the manifest, but no matching \"messages.json\" in the \"_locales\" directory exists. See: https://mzl.la/2hjcaEE":[ "Gódnota „default_locale“ jo w manifesće pódana, ale wótpowědny „messages.json“ w zapisu „_locales“ njeeksistěrujo. Glejśo: https://mzl.la/2hjcaEE" ],
      "The \"default_locale\" is missing but \"_locales\" exist.":[ "\"default_locale\" felujo, ale \"_locales\" eksistěruju." ],
      "The \"default_locale\" value is not specifed in the manifest, but a \"_locales\" directory exists. See: https://mzl.la/2hjcaEE":[ "Gódnota „default_locale“ njejo w manifesće pódana, ale zapis „_locales“ eksistěrujo. Glejśo: https://mzl.la/2hjcaEE" ],
      ...
      "\"strict_min_version\" requires Firefox %(minVersion)s, which was released before version %(versionAdded)s introduced support for \"%(key)s\".":[ "„strict_min_version“ se Firefox %(minVersion)s pomina, kótaryž jo se wózjawił pśed wersiju %(versionAdded)s, kótaraž jo zawjadła pódpěru za „%(key)s“." ],
      ...
      "\"strict_min_version\" requires Firefox for Android %(minVersion)s, which was released before version %(versionAdded)s introduced support for \"%(key)s\".":[ "„strict_min_version“ se Firefox za Android %(minVersion)s pomina, kótaryž jo se wózjawił pśed wersiju %(versionAdded)s, kótaraž jo zawjadła pódpěru za „%(key)s“." ],
      ...
      "incognito \"split\" is unsupported.":[ "incognito „split“ se njepódpěra." ],
