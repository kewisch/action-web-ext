module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "\"split\" в режиме инкогнито не поддерживается." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Параметр \"split\" для режима инкогнито не поддерживается и будет рассматриваться в Firefox как \"not_allowed\". Удалите этот ключ из файла манифеста, если ваше расширение совместимо с режимом приватного просмотра Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "Свойство «admin_install_only» зарезервировано." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Свойство «admin_install_only» зарезервировано и может использоваться только в корпоративных дополнениях." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "Свойство \"/browser_specific_settings/gecko/admin_install_only\" должно быть установлено в \"true\"." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "В корпоративном дополнении свойство «admin_install_only» должно быть установлено в «true»." ],
