module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
        ...
        lang:"ca" },
      "Validation Summary:":[ "Resum de la validació:" ],
      Code:[ "Codi" ],
      Message:[ "Missatge" ],
      ...
      "{{api}} is not supported":[ "{{api}} no és compatible" ],
      ...
      "Content script file could not be found.":[ "No s'ha trobat el fitxer de script de contingut." ],
      ...
      "Reserved filename found.":[ "S'ha trobat un nom de fitxer reservat." ],
      ...
      "The field is required.":[ "El camp és obligatori." ],
      ...
      "The field is invalid.":[ "El camp no és vàlid." ],
      ...
      "Icons must be square.":[ "Les icones han de ser quadrades." ],
      "Icon at \"%(path)s\" must be square.":[ "La icona a «%(path)s» ha de ser quadrada." ],
      "The size of the icon does not match the manifest.":[ "" ],
      "Expected icon at \"%(path)s\" to be %(expected)d pixels wide but was %(actual)d.":[ "" ],
      "Corrupt image file":[ "El fitxer d'imatge està malmès" ],
