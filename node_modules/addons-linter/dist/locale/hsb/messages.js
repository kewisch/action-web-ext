module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "JavaScript libraries are discouraged for simple add-ons, but are generally accepted.":[ "Za jednore přidatki wot bibliotekow JavaScript wotradźeja, ale zwjetša je akceptuja." ],
      ...
      "Content script file name should not be empty":[ "Mjeno wobsahoweje skriptoweje dataje njeměło prózdne być" ],
      "\"%(method)s\" called with a non-literal uri":[ "„%(method)s“ je so z njeliteralnym uri wuwołała" ],
      ...
      "\"%(method)s\" called with non-local URI":[ "„%(method)s“ je so z njelokalnym uri wowołała" ],
      ...
      "\"%(property)s\" allows 'eval', which has strong security and performance implications.":[ "„%(property)s“ ‚eval‘ dowoluje, štož ma sylne wuskutki na wěstotu a wukon." ],
      ...
      "\"%(fieldName)s\" manifest field is only used for privileged and temporarily installed extensions.":[ "Manifestowe polo „%(fieldName)s“ so jenož za priwilegowane a na chwilu instalowane rozšěrjenja wužiwa." ],
      ...
      "Please refer to https://github.com/mozilla-extensions/xpi-manifest to learn more about privileged extensions and signing.":[ "Čitajće prošu https://github.com/mozilla-extensions/xpi-manifest, zo byšće wjace wo priwilegowanych rozšěrjenjach a signowanju zhonił." ],
      ...
      "\"%(fieldName)s\" is not supported in manifest versions %(versionRange)s.":[ "„%(fieldName)s“ so w manifestowych wersijach %(versionRange)s njepodpěruje." ],
      ...
      "The \"default_locale\" value is specified in the manifest, but no matching \"messages.json\" in the \"_locales\" directory exists. See: https://mzl.la/2hjcaEE":[ "Hódnota „default_locale“ je w manifesće podata, ale wotpowědny „messages.json“ w zapisu „_locales“ njeeksistuje. Hlejće: https://mzl.la/2hjcaEE" ],
      "The \"default_locale\" is missing but \"_locales\" exist.":[ "\"default_locale\" faluje, ale \"_locales\" eksistuje." ],
      "The \"default_locale\" value is not specifed in the manifest, but a \"_locales\" directory exists. See: https://mzl.la/2hjcaEE":[ "Hódnota „default_locale“ w manifesće podata njeje, ale zapis „_locales“ eksistuje. Hlejće: https://mzl.la/2hjcaEE" ],
      ...
      "\"strict_min_version\" requires Firefox %(minVersion)s, which was released before version %(versionAdded)s introduced support for \"%(key)s\".":[ "„strict_min_version“ sej Firefox %(minVersion)s wužaduje, kotryž je so před wersiju %(versionAdded)s wozjewił, kotraž je podpěru za „%(key)s“ zawjedła." ],
      ...
      "\"strict_min_version\" requires Firefox for Android %(minVersion)s, which was released before version %(versionAdded)s introduced support for \"%(key)s\".":[ "„strict_min_version“ sej Firefox za Android %(minVersion)s wužaduje, kotryž je so před wersiju %(versionAdded)s wozjewił, kotraž je podpěru za „%(key)s“ zawjedła." ],
      ...
      "incognito \"split\" is unsupported.":[ "incognito „split“ so njepodpěruje." ],
