module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Duplicate key found in JSON file.":[ "Fann duplikatnøkkel i JSON-fila." ],
      ...
      "\"%(property)s\" is required":[ "\"%(property)s\" er påkravd" ],
      ...
      "/%(fieldName)s: \"%(permissionName)s\" is not supported.":[ "/%(fieldName)s: \"%(permissionName)s\" er ikkje stødd." ] } } }