module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "不支援 incognito 的「split」參數。" ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "不支援 incognito 的「split」參數值，在 Firefox 將視為「not_allowed」。若您的擴充套件與 Firefox 的隱私瀏覽模式相容，請從安裝資訊檔中移除這組鍵值。" ],
      "The \"admin_install_only\" property is reserved.":[ "「admin_install_only」屬性已被保留。" ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "「admin_install_only」屬性已被保留，僅可使用於企業用附加元件。" ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "「/browser_specific_settings/gecko/admin_install_only」屬性必須設定為「true」。" ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "企業用附加元件的「admin_install_only」屬性必須設定為「true」。" ],
