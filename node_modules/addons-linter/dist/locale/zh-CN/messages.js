module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "不支持无痕模式“split”。" ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "无痕模式“split”值不受支持，在 Firefox 中将被视同“not_allowed”。若您的扩展需要与 Firefox 的隐私浏览模式兼容，请从清单文件中移除此键。" ],
      "The \"admin_install_only\" property is reserved.":[ "“admin_install_only”属性为保留属性。" ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "“admin_install_only”属性为保留属性，只能在企业用附加组件中使用。" ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "“/browser_specific_settings/gecko/admin_install_only”属性必须设置为“true”。" ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "企业用附加组件中的“admin_install_only”属性必须设置为“true”。" ],
