module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "行" ],
      Column:[ "列" ],
      "Invalid nesting of selectors found":[ "发现无效的选择器嵌套" ],
      "A CSS syntax error was encountered":[ "遇到一个CSS 语法错误" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "调用了 addEventListener，且第四个参数为真。" ],
      ...
      "Unadvised 3rd-party JS library":[ "不推荐的第三方 JS 库" ],
      ...
      "A custom content_security_policy needs additional review.":[ "自定义的 content_security_policy 将需要额外审查。" ],
      "The \"name\" property must be a string.":[ "“name”属性必须是字符串。" ],
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "详细信息请参阅 http://mzl.la/1STmr48 (MDN 文档)。" ],
      "The field is required.":[ "该字段必填。" ],
      "The \"version\" property must be a string.":[ "“version”属性必须是字符串。" ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "详细信息请参阅 http://mzl.la/1kXIADa (MDN文档)。" ],
      "The \"version\" property uses a Firefox-specific format.":[ "\"version\" 属性须使用 Firefox 要求的格式。" ] } } }