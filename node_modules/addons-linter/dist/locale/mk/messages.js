module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Your JSON is not valid.":[ "Вашиот JSON не е валиден." ],
      ...
      "The field is required.":[ "Полето е задолжително." ],
      ...
      "Unknown permission.":[ "Непозната дозвола." ],
      ...
      "Icons must be square.":[ "Иконите мора да бидат квадратни." ],
