module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
        ...
        lang:"ur" },
      "Validation Summary:":[ "توثیقی خلاصہ:" ],
      Code:[ "کوڈ" ],
      Message:[ "پیغام" ],
      Description:[ "وضاحت" ],
      File:[ "فائل" ],
      ...
      "Your FTL is not valid.":[ "آپ کا FTL جائز نہیں ہے۔" ],
      ...
      "{{api}} is not supported":[ "{{api}} کی معاونت نہیں ہے" ],
      "This API has not been implemented by Firefox.":[ "اس API کی Firefox کی طرف سے تنصیب نہیں کی گئی۔" ],
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "" ],
      "Content script file could not be found.":[ "مواد کی اسکرپٹ فائل نہیں مل سکی۔" ],
      ...
      "Content script file name should not be empty.":[ "مواد کی اسکرپٹ فائل کا نام خالی نہیں ہونا چاہئے۔" ],
      "Content script file name should not be empty":[ "مواد کی اسکرپٹ فائل کا نام خالی نہیں ہونا چاہئے" ],
      ...
      "Duplicate keys are not allowed in JSON files.":[ "JSON فائلوں میں ڈپلیکیٹ کیز کی اجازت نہیں ہے۔" ],
      "Duplicate key found in JSON file.":[ "" ],
      "Your JSON is not valid.":[ "آپ کا JSONجائز نہیں ہے۔" ],
      ...
      "We were unable to decompress the zip file.":[ "ہم زپ فائل کو ڈی کمپریس کرنے سے قاصر تھے۔" ],
      "manifest.json was not found":[ "manifest.json نہیں ملا" ],
      ...
      "File is too large to parse.":[ "تجزیہ کرنے کے لئے فائل بہت بڑی ہے۔" ],
      ...
      "Package contains duplicate entries":[ "پیکیج میں ڈپلیکیٹ اندراجات شامل ہیں" ],
      ...
      "Package already signed":[ "پیکج پہلے ہی دستخط شدہ ہے" ],
      ...
      "Placeholder for message is missing":[ "پیغام کے لئے پلیس ہولڈر غائب ہے" ],
      "A placeholder used in the message is not defined.":[ "" ],
      "Placeholder name contains invalid characters":[ "پلیس ہولڈر کا نآم غلط حروف پر مشتمل ہے" ],
      "Placeholder name should only contain alpha-numeric characters, _ and @ (https://mzl.la/2ExbYez).":[ "" ],
      "Placeholder is missing the content property":[ "پلیس ہولڈر میں مواد کی خصوصیات غائب ہے" ],
      ...
      "The size of the icon does not match the manifest.":[ "آئیکن کا سائز منشور سے مماثل نہیں رکھتا  ہے۔" ],
      "Expected icon at \"%(path)s\" to be %(expected)d pixels wide but was %(actual)d.":[ "" ],
      "Corrupt image file":[ "فریب تصویر کی فائل" ],
      ...
      "Empty language directory":[ "خالی زبان ڈائریکٹری" ],
