module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Your FTL is not valid.":[ "FTL er ikke gyldig." ],
      "Your FTL file could not be parsed.":[ "Din FTL-fil kunne ikke tolkes." ],
      "Remote scripts are not allowed as per the Add-on Policies.":[ "Eksterne scripts er ikke tilladt i henhold til politikken for tilføjelser." ],
      "Please include all scripts in the add-on. For more information, refer to https://mzl.la/2uEOkYp.":[ "" ],
      "Inline scripts blocked by default":[ "Inline-scripts er blokeret som standard" ],
      "Default CSP rules prevent inline JavaScript from running (https://mzl.la/2pn32nd).":[ "" ],
      "Unadvised 3rd-party JS library":[ "Ikke-anbefalet tredjeparts JS-bibliotek" ],
      "Your add-on uses a JavaScript library we do not recommend. Read more: https://bit.ly/1TRIyZY":[ "" ],
      "Known JS library detected":[ "Kendt JS-bibliotek detekteret" ],
      ...
      "{{api}} is not supported":[ "{{api}} er ikke understøttet" ],
      "This API has not been implemented by Firefox.":[ "Denne API er ikke blevet implementeret af Firefox." ],
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "" ],
      "Content script file could not be found.":[ "Indholds-scriptfilen blev ikke fundet." ],
      ...
      "{{api}} is not supported in Firefox version {{minVersion}}":[ "{{api}} understøttes ikke i Firefox {{minVersion}}" ],
      "This API is not implemented by the given minimum Firefox version":[ "Denne API er ikke implementeret af den angivne minimumsversion af Firefox" ],
      "{{api}} is not supported in Firefox for Android version {{minVersion}}":[ "{{api}} understøttes ikke i Firefox til Android version {{minVersion}}" ],
      "This API is not implemented by the given minimum Firefox for Android version":[ "Denne API er ikke implementeret af den angivne minimumsversion af Firefox til Android" ],
      "Content script file name should not be empty.":[ "Indholds-scriptfilens navn bør ikke være tomt." ],
      "Content script file name should not be empty":[ "Indholds-scriptfilens navn bør ikke være tomt" ],
      ...
      "JavaScript syntax error":[ "JavaScript-syntaksfejl" ],
      ...
      "Unexpected global passed as an argument":[ "Uventet global blev anvendt som argument" ],
      "Passing a global as an argument is not recommended. Please make this a var instead.":[ "" ],
      "Use of document.write strongly discouraged.":[ "Brug af document.write frarådes kraftigt." ],
      ...
      "Banned 3rd-party JS library":[ "Forbudt tredjeparts JS-bibliotek" ],
      "Your add-on uses a JavaScript library we consider unsafe. Read more: https://bit.ly/1TRIyZY":[ "" ],
      "Your JSON contains block comments.":[ "JSON indeholder block-kommentarer." ],
      ...
      "Your JSON is not valid.":[ "Din JSON er ikke gyldig." ],
      "Your JSON file could not be parsed.":[ "Din JSON-fil kunne ikke fortolkes." ],
      ...
      "We were unable to decompress the zip file.":[ "Vi kunne ikke pakke zip-filen ud." ],
      "manifest.json was not found":[ "manifest.json blev ikke fundet" ],
      ...
      "File is too large to parse.":[ "Filen er for stor til at kunne fortolkes." ],
      ...
      "Unknown permission.":[ "Ukendt tilladelse." ],
      ...
      "The field is invalid.":[ "Feltet er ugyldigt." ],
