module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Your FTL file could not be parsed.":[ "Klarte ikke å tolke FTL-filen din." ],
      "Remote scripts are not allowed as per the Add-on Policies.":[ "Eksterne skripter er ikke tillatt, i henhold til utvidelsesretningslinjene." ],
      "Please include all scripts in the add-on. For more information, refer to https://mzl.la/2uEOkYp.":[ "" ],
      "Inline scripts blocked by default":[ "Inline-script er blokkert som standard" ],
      "Default CSP rules prevent inline JavaScript from running (https://mzl.la/2pn32nd).":[ "" ],
      "Unadvised 3rd-party JS library":[ "Ikke-anbefalt tredjeparts JS-bibliotek" ],
      "Your add-on uses a JavaScript library we do not recommend. Read more: https://bit.ly/1TRIyZY":[ "" ],
      "Known JS library detected":[ "Kjent JS-bibliotek oppdaget" ],
      ...
      "{{api}} is not supported":[ "{{api}} støttes ikke" ],
      "This API has not been implemented by Firefox.":[ "Denne API-en har ikke blitt implementert av Firefox." ],
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "" ],
      "Content script file could not be found.":[ "Innholdsskriptfilen ble ikke funnet." ],
      ...
      "{{api}} is not supported in Firefox version {{minVersion}}":[ "{{api}} er ikke støttet i Firefox versjon {{minVersion}}" ],
      "This API is not implemented by the given minimum Firefox version":[ "Denne API-en er ikke implementert av den gitte minimumsversjonen av Firefox" ],
      "{{api}} is not supported in Firefox for Android version {{minVersion}}":[ "{{api}} er ikke støttet i Firefox for Android versjon {{minVersion}}" ],
      "This API is not implemented by the given minimum Firefox for Android version":[ "Denne API-en er ikke implementert av den gitte minimumsversjonen av Firefox for Android" ],
      ...
      "JavaScript syntax error":[ "JavaScript-syntaksfeil" ],
      ...
      "Your JSON is not valid.":[ "Din JSON er ugyldig." ],
      ...
      "We were unable to decompress the zip file.":[ "Vi klarte ikke å pakke ut zip-filen." ],
      "manifest.json was not found":[ "manifest.json ble ikke funnet" ],
      ...
      "Firefox add-ons are not allowed to run coin miners.":[ "Firefox-tillegg har ikke lov til å kjøre myntutvinning." ],
      ...
      "Unknown permission.":[ "Ukjent tillatelse." ],
      ...
      "\"strict_max_version\" not required.":[ "«strict_max_version» er ikke påkrevd." ],
      ...
      "Icons must be square.":[ "Ikoner må være kvadratisk." ],
      "Icon at \"%(path)s\" must be square.":[ "Ikonet på \"%(path)s\" må være kvadratisk." ],
      ...
      "Unsupported image extension":[ "Filendelse for bilde ikke støttet" ],
