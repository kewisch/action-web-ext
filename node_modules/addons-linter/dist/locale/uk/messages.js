module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
        ...
        lang:"uk" },
      "Validation Summary:":[ "Підсумок валідації:" ],
      Code:[ "Код" ],
      ...
      "This API has not been implemented by Firefox.":[ "Цей API не було впроваджено в Firefox." ],
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "\"{{api}}\" вилучено у маніфесті версії 3 (властивість `manifest_version`)" ],
      "{{api}} is deprecated":[ "{{api}} більше не підтримується" ],
      "This API has been deprecated by Firefox.":[ "Firefox більше не підтримує цей API." ],
      "Content script file could not be found.":[ "Не вдається знайти файл скрипту вмісту." ],
      "\"{{api}}\" is deprecated or unimplemented":[ "\"{{api}}\" більше не підтримується або прибрано" ],
      "Content script file could not be found":[ "Не вдається знайти файл скрипту вмісту" ],
      ...
      "This API is not implemented by the given minimum Firefox version":[ "Цей API не впроваджено в Firefox вказаної мінімальної версії" ],
      "{{api}} is not supported in Firefox for Android version {{minVersion}}":[ "{{api}} не підтримується в Firefox для Android версії {{minVersion}}" ],
      "This API is not implemented by the given minimum Firefox for Android version":[ "Цей API не впроваджено в Firefox для Android вказаної мінімальної версії" ],
      ...
      "No \"message\" message property is set for a string (https://mzl.la/2DSBTjA).":[ "Властивість повідомлення \"message\" для рядка не задано (https://mzl.la/2DSBTjA)." ],
      "The field is required.":[ "Це поле обов'язкове." ],
      "The permission type is unsupported.":[ "Тип дозволу не підтримується." ],
      "See https://mzl.la/1R1n1t0 (MDN Docs) for more information.":[ "Перегляньте https://mzl.la/1R1n1t0 (Документацію MDN) для отримання докладної інформації." ],
      "See https://mzl.la/1ZOhoEN (MDN Docs) for more information.":[ "Перегляньте https://mzl.la/1ZOhoEN (Документацію MDN) для отримання докладної інформації." ],
      "See https://mzl.la/2Qn0fWC (MDN Docs) for more information.":[ "Перегляньте https://mzl.la/2Qn0fWC (Документацію MDN) для отримання докладної інформації." ],
      "See https://mzl.la/3Woeqv4 (MDN Docs) for more information.":[ "Перегляньте https://mzl.la/3Woeqv4 (Документацію MDN) для отримання докладної інформації." ],
      ...
      "The \"name\" property must be a string with no leading/trailing whitespaces.":[ "Властивість \"name\" має бути рядком без пробілів на початку/у кінці." ],
      ...
      "Icon could not be found at \"%(path)s\".":[ "Не вдалося знайти піктограму в \"%(path)s\"." ],
      "A background script defined in the manifest could not be found.":[ "Не вдалося знайти визначений в маніфесті скрипт заднього плану." ],
      "A background page defined in the manifest could not be found.":[ "Не вдалося знайти визначену в маніфесті сторінку заднього плану." ],
      "Background script could not be found at \"%(path)s\".":[ "Не вдалося знайти фоновий скрипт в \"%(path)s\"." ],
      ...
      "A content script css file defined in the manifest could not be found.":[ "Не вдалося знайти визначений в маніфесті css файл зі скриптом вмісту." ],
      "Content script defined in the manifest could not be found at \"%(path)s\".":[ "Не вдалося знайти визначений в маніфесті скрипт вмісту в \"%(path)s\"." ],
      "Content script css file defined in the manifest could not be found at \"%(path)s\".":[ "Не вдалося знайти визначений в маніфесті css файл в \"%(path)s\"." ],
      "A dictionary file defined in the manifest could not be found.":[ "Не вдалося знайти визначений в маніфесті файл словника." ],
      ...
      "Multiple dictionaries were defined in the manifest, which is unsupported.":[ "В маніфесті визначено декілька словників, що не підтримується." ],
      "The manifest contains a dictionaries object, but it is empty.":[ "Маніфест містить об'єкт словників, але він порожній." ],
      "A dictionaries object was defined in the manifest, but it was empty.":[ "В маніфесті визначено об'єкт словників, але він порожній." ],
      "The manifest contains a dictionary but no id property.":[ "Маніфест містить словник, але не властивість id." ],
      "A dictionary was found in the manifest, but there was no id set.":[ "В маніфесті знайдено словник, але немає встановленого id." ],
      "Forbidden content found in add-on.":[ "В додатку знайдено заборонений вміст." ],
      ...
      "Expected icon file at \"%(path)s\" is corrupted":[ "Очікуваний файл піктограми в \"%(path)s\" пошкоджений" ],
      "This property has been deprecated.":[ "Ця властивість більше не підтримується." ],
      "This theme LWT alias has been removed in Firefox 70.":[ "Цей псевдонім LWT-теми було вилучено в Firefox 70." ],
      "See https://mzl.la/2T11Lkc (MDN Docs) for more information.":[ "Перегляньте https://mzl.la/2T11Lkc (Документацію MDN) для отримання докладної інформації." ],
      "Theme image for \"%(type)s\" could not be found at \"%(path)s\"":[ "Зображення теми для \"%(type)s\" не вдалося знайти в \"%(path)s\"" ],
      "Corrupted theme image file":[ "Пошкоджений файл зображення теми" ],
      "Theme image file at \"%(path)s\" is corrupted":[ "Файл зображення теми в \"%(path)s\" пошкоджений" ],
