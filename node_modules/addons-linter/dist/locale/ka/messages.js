module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ null,
        "„{{api}}“ მოცილებულია მანიფესტის მე-3 ვერსიიდან (`manifest_version` – თვისება)" ],
      ...
      "Invalid install origin.":[ null,
        "ჩადგმის უმართებულო წარმომავლობა." ],
      "Invalid install origin. A valid origin has - only - a scheme, hostname and optional port.":[ null,
        "ჩადგმის არასწორი წარმომავლობა. მართებულს აქვს – მხოლოდ – სქემა, ჰოსტის სახელი და შერჩეული პორტი." ],
      ...
      "Linking to \"addons.mozilla.org\" is not allowed":[ null,
        "ბმული „addons.mozilla.org“ მისამართთან აკრძალულია" ],
      ...
      "The extension ID is required in Manifest Version 3 and above.":[ null,
        "გაფართოებას ნომრით ID ესაჭიროება მე-3 ვერსიის ან უფრო ახალი Manifest." ],
      "See https://mzl.la/3PLZYdo for more information.":[ null,
        "იხილეთ https://mzl.la/3PLZYdo ვრცლად." ] } } }