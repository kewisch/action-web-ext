module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "A CSS syntax error was encountered":[ "Alcontróse un fallu de sintaxis nel CSS" ],
      ...
      "We were unable to decompress the zip file.":[ "Nun fuimos a descomprimir el ficheru ZIP." ],
      "manifest.json was not found":[ "" ],
      "File is too large to parse.":[ "El ficheru ye mui grande como pa analizalu." ],
      "Hidden file flagged":[ "" ],
      ...
      "Firefox add-ons are not allowed to run coin miners.":[ "Los complementos pa Firefox nun tienen permisu pa executar mineros de divises dixitales." ],
      ...
      "Forbidden content found in add-on.":[ "Alcontróse conteníu prohibíu nel complementu." ],
      "This add-on contains forbidden content.":[ "Esti complementu contién conteníu prohibíu." ],
      "The permission type is unsupported.":[ "" ],
      "Icons must be square.":[ "Los iconos han ser cuadraos." ],
      ...
      "Unknown permission.":[ "Desconozse'l permisu." ],
      ...
      "See https://mzl.la/20PenXl (MDN Docs) for more information.":[ "Mira https://mzl.la/20PenXl (documentación de MDN) pa más información." ],
      ...
      "The \"name\" property must be a string.":[ "La propiedá «name» ha ser una cadena." ],
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "Mira http://mzl.la/1STmr48 (documentación de MDN) pa más información." ],
      "The field is required.":[ "Ríquese'l campu." ],
      "The \"version\" property must be a string.":[ "La propiedá «version» ha ser una cadena." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Mira http://mzl.la/1kXIADa (documentación de MDN) pa más información." ],
      "The \"version\" property uses a Firefox-specific format.":[ "La propiedá «version» usa un formatu específicu de Firefox." ] } } }