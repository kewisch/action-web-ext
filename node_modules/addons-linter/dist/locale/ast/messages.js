module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Firefox add-ons are not allowed to run coin miners.":[ "Los complementos pa Firefox nun tienen permisu pa executar criptomineros." ],
      ...
      "See https://mzl.la/1R1n1t0 (MDN Docs) for more information.":[ "Mira https://mzl.la/1R1n1t0 (documentación de MDN) pa consiguir más información." ],
      ...
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "Mira http://mzl.la/1STmr48 (documentación de MDN) pa consiguir más información." ],
      ...
      "Forbidden content found in add-on.":[ "Nel complementu atopóse conteníu que ta prohibíu." ],
      ...
      "Icon at \"%(path)s\" must be square.":[ "L'iconu de «%(path)s» ha ser cuadráu." ],
      ...
      "See https://mzl.la/2T11Lkc (MDN Docs) for more information.":[ "Mira https://mzl.la/2T11Lkc (documentación de MDN) pa consiguir más información." ],
      ...
      "The \"default_locale\" is missing but \"_locales\" exist.":[ "Falta «default_locale» mas «_locales» esiste." ],
