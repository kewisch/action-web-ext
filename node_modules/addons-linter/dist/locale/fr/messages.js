module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "La valeur « split » d’incognito n’est pas prise en charge." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "La valeur « split » d’incognito n’est pas prise en charge et est traitée comme « not_allowed » dans Firefox. Supprimez cette clé du fichier manifest si votre extension est compatible avec la navigation privée de Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "La propriété « admin_install_only » est réservée." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "La propriété « admin_install_only » est réservée et ne peut être utilisée que par des modules complémentaires d’entreprise." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "La valeur de la propriété « /browser_specific_settings/gecko/admin_install_only » doit être « true »." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "La valeur de la propriété « admin_install_only » doit être « true » dans un module complémentaire d’entreprise." ],
