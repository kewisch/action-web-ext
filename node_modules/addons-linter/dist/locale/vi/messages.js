module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "A placeholder used in the message is not defined.":[ null,
        "Placeholder được sử dụng trong tin nhắn không được xác định." ],
      "Placeholder name contains invalid characters":[ null,
        "Tên của placeholder chứa ký tự không hợp lệ" ],
      "Placeholder is missing the content property":[ null,
        "Placeholder thiếu thuộc tính content" ],
      ...
      "Invalid install origin.":[ null,
        "Nguồn gốc cài đặt không hợp lệ." ],
      "Invalid install origin. A valid origin has - only - a scheme, hostname and optional port.":[ null,
        "Nguồn gốc cài đặt không hợp lệ. Nguồn gốc hợp lệ chỉ có - một scheme, tên máy chủ và cổng tùy chọn." ],
      ...
      "The extension ID is required in Manifest Version 3 and above.":[ null,
        "ID tiện ích là bắt buộc trong tập tin manifest phiên bản 3 trở lên." ],
      "See https://mzl.la/3PLZYdo for more information.":[ null,
        "Xem tại https://mzl.la/3PLZYdo để biết thêm thông tin." ] } } }