module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "Giá trị ẩn danh \"split\" không được hỗ trợ." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Giá trị ẩn danh \"split\" không được hỗ trợ và sẽ được coi là \"not_allowed\" trong Firefox. Hãy xóa khóa trong tập tin manifest, nếu tiện ích mở rộng của bạn tương thích với chế độ duyệt web riêng tư của Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "Thuộc tính \"admin_install_only\" bị giữ lại." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Thuộc tính \"admin_install_only\" bị giữ lại và chỉ có thể được sử dụng trong tiện ích dành cho doanh nghiệp." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "Thuộc tính \"/browser_specific_settings/gecko/admin_install_only\" bắt buộc phải là \"true\"." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "Thuộc tính \"admin_install_only\" bắt buộc phải là \"true\" trong tiện ích dành cho doanh nghiệp." ],
