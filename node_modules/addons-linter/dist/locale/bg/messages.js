module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "Known JS library detected":[ "Открита известна JS библиотека" ],
      ...
      "{{api}} is not supported":[ "{{api}} не се поддържа" ],
      "This API has not been implemented by Firefox.":[ "" ],
      "\"{{api}}\" has been removed in Manifest Version 3 (`manifest_version` property)":[ "" ],
      "{{api}} is deprecated":[ "{{api}} е изведено от употреба" ],
      "This API has been deprecated by Firefox.":[ "Този ППИ е изведен от употреба от Firefox." ],
      "Content script file could not be found.":[ "" ],
      "\"{{api}}\" is deprecated or unimplemented":[ "„{{api}}“ е изведено от употреба или нереализирано" ],
      "Content script file could not be found":[ "" ],
      ...
      "{{api}} is not supported in Firefox version {{minVersion}}":[ "{{api}} не се поддържа от издание {{minVersion}} на Firefox" ],
      ...
      "The field is invalid.":[ "Полето е невалидно." ],
