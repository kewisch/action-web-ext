module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "Le navigation private \"split\" non es supportate." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Le valor \"split\" del clave \"incognito\" non es supportate e sera tractate como \"not_allowed\" in Firefox. Remove le clave del file manifesto si le extension es compatibile con le navigation anonyme de Firefox." ],
      "The \"admin_install_only\" property is reserved.":[ "Le proprietate “admin_install_only” es reservate." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Le proprietate \"admin_install_only\" es reservate e pote solo esser usate in additivos de interprisa." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "\"/browser_specific_settings/gecko/admin_install_only\" proprietate debe haber le valor \"true\"." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "\"/browser_specific_settings/gecko/admin_install_only\" proprietate debe haber le valor \"true\"." ],
