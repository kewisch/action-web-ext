module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "The \"admin_install_only\" property is reserved.":[ "Vetia “admin_install_only” është e rezervuar." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Vetia “admin_install_only” është e rezervuar dhe mund të përdoret vetëm në shtesa për ndërmarrje." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "Vetia “/browser_specific_settings/gecko/admin_install_only” duhet vënë si “true”." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "Vetia “admin_install_only”, te një shtesë ndërmarrjesh, duhet vënë si “true”." ],
