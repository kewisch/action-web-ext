module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "incognito \"split\" is unsupported.":[ "inkognito \"split\" nie je podporované." ],
      "The incognito \"split\" value is unsupported and will be treated as \"not_allowed\" in Firefox. Remove the key from the manifest file, if your extension is compatible with Firefox's private browsing mode.":[ "Hodnota inkognito \"split\" nie je podporovaná a vo Firefoxe sa s ňou bude zaobchádzať ako s \"not_allowed\". Odstráňte kľúč zo súboru manifestu, ak je vaše rozšírenie kompatibilné s režimom súkromného prehliadania Firefoxu." ],
      "The \"admin_install_only\" property is reserved.":[ "Vlastnosť \"admin_install_only\" je vyhradená." ],
      "The \"admin_install_only\" property is reserved and can only be used in enterprise add-ons.":[ "Vlastnosť \"admin_install_only\" je vyhradená a možno ju použiť iba v doplnkoch pre podniky." ],
      ...
      "\"/browser_specific_settings/gecko/admin_install_only\" property must be set to \"true\".":[ "Vlastnosť \"/browser_specific_settings/gecko/admin_install_only\" musí byť nastavená na hodnotu \"true\"." ],
      "The \"admin_install_only\" property must be set to \"true\" in an enterprise add-on.":[ "Vlastnosť \"admin_install_only\" musí byť v doplnku pre podniky nastavená na hodnotu \"true\"." ],
