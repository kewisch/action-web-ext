module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Riadok" ],
      Column:[ "Stĺpec" ],
      "Invalid nesting of selectors found":[ "Bolo nájdené neplatné vnorenie" ],
      "A CSS syntax error was encountered":[ "Naša sa chyba syntaxe CSS" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener bol volaný so štvrtým parametrom nastaveným na true." ],
      ...
      "Empty language directory":[ "Prázdny adresár s jazykmy" ],
      ...
      "A custom content_security_policy needs additional review.":[ "Vlastný content_security_policy vyžaduje dodatočné schválenie." ],
      "The \"name\" property must be a string.":[ "Vlastnosť „name“ musí byť reťazec." ],
      ...
      "The \"version\" property must be a string.":[ "Vlastnosť „version“ musí byť reťazec." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Ďalšie informácie nájdete na http://mzl.la/1kXIADa (dokumentácia na MDN)." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Vlastnosť „version“ používa vo Firefoxe špecifický formát." ] } } }